...
SRCS = parsing/main.c parsing/lexing/parse_info.c parsing/segregate_info.c parsing/split_errors.c \
	   ...
	   parsing/expansion/free_expand.c parsing/expansion/expand_one_token.c parsing/expansion/get_env.c parsing/split_cmds.c parsing/lexing/segments_utils.c src/export.c src/env_utils.c src/handle_cd.c src/apply_redirections.c \
