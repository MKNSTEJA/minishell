...
SRCS = parsing/main.c parsing/parse_info.c parsing/segregate_info.c parsing/split_errors.c \
	   ...
	   parsing/free_expand.c parsing/expand_one_token.c parsing/get_env.c parsing/split_cmds.c src/export.c src/env_utils.c src/handle_cd.c src/apply_redirections.c \
